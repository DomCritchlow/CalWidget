...
echo "   Install the helper tools and generate a key once:"
echo ""
echo "     brew install --cask sparkle      # or download from sparkle-project.org"
echo "     generate_keys                    # stores private key in your Keychain"
echo ""
echo "   To export the private key to a file for CI:"
echo "     generate_keys -x ~/.calwidget-sparkle-private.key"
